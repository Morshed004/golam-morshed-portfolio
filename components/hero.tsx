...
export function Hero() {
  ...
  const itemVariants = {
    ...
    visible: {
      ...
      transition: { 
        duration: 0.5, 
        ease: "easeOut" // Framer Motion expects specific string literals
      },
    },
  };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <Badge variant="secondary" className="px-4 py-1.5 text-sm font-medium border-primary/20 gap-2">
          ...
          >
            ...
            Specialized in creating <span className="text-foreground font-semibold">robust APIs</span> and 
            <span className="text-foreground font-semibold"> responsive user interfaces</span>.
          </motion.p>
          ...
          >
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button size="lg" className="rounded-full px-8 h-12 gap-2 shadow-xl shadow-primary/10" asChild>
          ...
          >
            ...
            >
              ...
              <div className="w-[26px] h-11 border-2 border-muted-foreground/30 rounded-full flex justify-center p-1.5">
                <motion.div 
                  animate={{ 
                    y: [0, 15, 0],
                    opacity: [1, 0.5, 1]
